...
// tyrannosaurus, carnivorous, 7000kg, 12m, Late Crestaceous
  const tyrannosaurus = {
    diet: "carnivorous",
    weight: 7000,
    length: 9,
    period: "Late Crestaceous"
  }
...
// velociraptor, carnivorous, 15kg, 1.8m, Late Crestaceous
const velociraptor = {
  diet: "carnivorous",
  weight: 15,
  length: 1.8,
...
const popTotal = zooAnimals.reduce(function(totalAnimals, item) {
